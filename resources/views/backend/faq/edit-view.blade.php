        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="{{route('updatefaq',$faq->id)}}" enctype="multipart/form-data">
                        @csrf
                        <p class="card-description"> FAQ Details </p>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>Question</label>
                                <input type="text" name="n_title" class="form-control" value="{{$faq->question}}">
                            ...
                            <div class="form-group col-md-12">
                                <label>Answer</label>
                                <textarea class="form-control" name="n_description">{{$faq->answer}}</textarea>
