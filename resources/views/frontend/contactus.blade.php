...
<div class="section1 border1">
    <div class="wrap5">
        <div class="title6">Contact us</div>
        <div class="box13">
            <div class="box13-in">
                <div class="box13-in-item2">
                    ...
                    <form method="POST" class="contacts-form" action="/contact">
                        <input type="hidden" name="_token" value="2TzQgAdUTAnSPKK1fd5rT9oBHhhLh4InMoukKhN3">                            <div class="form-wrap">
                            ...
                            <div class="box12-item4">
                                <input type="text" class="form-input-line2" placeholder="E-mail *" value="" name="email">
                            </div>

                            <div class="box12-item4">
                                <input type="text" class="form-input-line2" value=""
                                       placeholder="Please indicate here your order number, if you have a question regarding this order!" name="order">
                            </div>

                            <div class="box12-item4">
                                <select class="form-input-line2" name="warehouse" style="color:#fff;">
                                    <option value="">Please select warehouse *</option>
                                    <option value="1"  >Warehouse 1 (EU-based)</option>
                                    <option value="2"  >Warehouse 2 (International)</option>
                                    <option value="3"  >Warehouse 3 (US domestic)</option>
                                </select>
                            </div>

                            <div class="box12-item4 msgbox">
                                <textarea name="message" class="form-input-line2" placeholder="Comment *"></textarea>
                            </div>

                        </div>
                        <button type="submit" class="button4 submit-contacts-button">Send message</button>
                    </form>
