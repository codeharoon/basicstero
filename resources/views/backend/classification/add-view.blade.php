        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="{{route('storeclassification')}}" enctype="multipart/form-data">
                        @csrf
                        <p class="card-description"> Classification Detail </p>
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                <label>Name</label>
                                <input type="text" name="n_title" class="form-control" placeholder="Enter Classification name">
