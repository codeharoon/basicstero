        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="{{route('updatewarehouse',$warehouse->id)}}" enctype="multipart/form-data">
                        @csrf
                        <p class="card-description"> WareHouse Details </p>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>Title</label>
                                <input type="text" name="n_title" class="form-control" value="{{$warehouse->whouse}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" name="n_description">{{$warehouse->discription}}</textarea>
